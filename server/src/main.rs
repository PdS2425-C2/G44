...
async fn main() {
    ...
    let app = Router::new()
        ...
        .route("/api/chats/:chat_id/participants", get(routes::chats::get_chat_participants))
        .route("/api/chats/:chat_id/members/me", delete(routes::chats::leave_chat))
        .route("/api/chats/:chat_id/read", patch(routes::chats::patch_chat_read))
